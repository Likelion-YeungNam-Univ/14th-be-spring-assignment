...
### 1. 아기사자 등록
* **Endpoint:** `POST /api/v1/likelions`
* **핵심 미션:** 등록 전용 DTO(`CreateLikeLionReqDto`) 설계 및 적용
* **세부 조건:** * `id`를 제외한 모든 필드를 포함합니다.
   * 각 필드 성격에 맞는 **Validation**을 반드시 수행합니다.

### 2. 아기사자 전체 조회 및 학년별 필터링
* **Endpoint:** `GET /api/v1/likelions`
